...
num_procs=$(nproc --all)
num_procs=$((num_procs-6)) ####
python3 ../scripts/split_file.py ../data/cities.csv ${num_procs} ####
filePath=($(ls ../data/cities_part*.csv)) ####
fileName=($(ls ../data/cities_part*.csv | xargs -n 1 basename)) ####
len=${#filePath[@]}

./gervLibSerialize -DATASET ../data/cities.csv -DATASET_SEPARATOR , -PIVOT_SAMPLE_SIZE 0.5 -NUM_PIVOTS 2 -NUM_PER_LEAF 55 -FILE_NAME cities -OUTPUT_PATH ../data ####
