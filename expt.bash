...
#./gervLibTest -DATASET_NAME CITIES -INDEX VPTREE -DATASET_TRAIN ../data/cities_norm.csv -DATASET_TRAIN_SEPARATOR , -DATASET_TEST ../data/cities_norm.csv -DATASET_TEST_SEPARATOR , -DISTANCE_FUNCTION EUCLIDEAN -PIVOT_TYPE RANDOM -PIVOT_SAMPLE_SIZE 1.0 -NUM_PIVOTS 2 -SEED 14 -K_MAX 100
