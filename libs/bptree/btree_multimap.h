...
public:
    ...
    typedef stx::btree<O, T, key_type, data_type, value_type, key_compare,
...
public:
    typedef typename btree_impl::node Node;
    typedef typename btree_impl::leaf_node Leaf;
    typedef typename btree_impl::inner_node Inner;

public:
	// DIY functions

//    void setHilbertCurve(HilbertCurve _hc)
//    {
//
//        tree.hc = _hc;
//
...
//    {
//        tree.init_Key_Minmax();
//    }
//
//    void dump_Key_Minmax()
//    {
//        tree.dump_Key_Minmax();
//    }
//
//    void test()
//    {
...
//		tree.pageAccess = 0;
//		tree.LRU.init(MEM_CACHE_SIZE, MEM_PAGE_SIZE, pageSize);
//		tree.rangeQuery(qloc, radius, answers, qmbr);
//		tree.pageAccess += tree.LRU.pageAccessNum;
//	}
	
//	void knnQuery(location_t& qloc, int kth, vector<data_type>& answers, double (*MIND)(int[][2])) {
//		tree.pageAccess = 0;
//		tree.LRU.init(MEM_CACHE_SIZE, MEM_PAGE_SIZE, pageSize);
//		tree.knnQuery(qloc, kth, answers, MIND);
//		tree.pageAccess += tree.LRU.pageAccessNum;
//	}
	
//	long long getPageAccess() {
//		return tree.pageAccess;
//	}
...
public:
    ...
    void setHilbertCurve(gervLib::hilbert::HilbertCurve* _hc)
    {
